...
def trainModel(model_path, load_model=False):
    ...
    with open('Deeplearning_3D/dataset_filenames_off.json', 'r') as f:
            dataset_filenames = json.load(f)

    train_filenames = dataset_filenames['train_filenames']
    validation_filenames = dataset_filenames['validation_filenames']

    train_filenames = train_filenames                # NOTE: Change test file number to increase performance time
    validation_filenames = validation_filenames      # NOTE: Change test file number to increase performance time
